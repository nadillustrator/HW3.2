...
class StudentServiceTest {
    ...
    void positiveUpdateStudentTest() {
        studentService.createStudent(student1);
        assertEquals(studentService.updateStudent(1L, student3), student3);
    }

    @Test
    void negativeUpdateStudentTest() {
        studentService.createStudent(student1);
        assertNull(studentService.updateStudent(3L, student3));
    }
    ...
    void negativeDeleteStudentTest() {
        ...
        studentService.createStudent(student2);
        studentService.createStudent(student3);
        assertNull(studentService.deleteStudent(5L));
    }
